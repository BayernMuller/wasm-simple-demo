...
0. **[Emscripten](https://emscripten.org/docs/getting_started/downloads.html)** 설치하기
   ...
   # 현재 사용자를 위해 "latest" SDK를 "활성화" (.emscripten 파일 생성)
   ./emsdk activate latest

   # 현재 터미널에서 PATH 및 기타 환경 변수 활성화
   source ./emsdk_env.sh
   ```
...
![](assets/set-up-github-pages-1.png)
![](assets/set-up-github-pages-2.png)
![](assets/set-up-github-pages-3.png)
